...
class AssetController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('asset.list', compact('users', 'statuses'));
    }
    ...
    public function create(CountryRepository $countryRepository, RoleRepository $roleRepository)
    {
        ...
        return view('asset.add', compact('countries', 'roles', 'statuses'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('asset.list')
            ->withSuccess('Asset Acceptance has been created!');
    }
    ...
    public function updateDetails(User $user, Request $request)
    {
        ...
        return redirect()->route('asset.list')
            ->withSuccess('Asset Acceptance has been updated!');
