...
class RegistrationController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('registration.list', compact('users', 'statuses'));
    }
    ...
    public function create(CountryRepository $countryRepository, RoleRepository $roleRepository)
    {
        ...
        return view('registration.capital_asset.add', compact('countries', 'roles', 'statuses'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('registration.list')
            ->withSuccess('Asset Registration has been created!');
    }
    ...
    public function updateDetails(User $user, Request $request)
    {
        ...
        return redirect()->route('registration.list')
            ->withSuccess('Asset Registration has been updated!');
