...
class RejectionController extends Controller
{
     ...
     */
    public function __construct(UserRepository $users, AssetRepository $assets)
    {
        $this->middleware('auth');
        $this->middleware('session.database', ['only' => ['sessions', 'invalidateSession']]);
        $this->middleware('permission:assets.manage');
        $this->users = $users;
        $this->assets = $assets;
    }
    ...
    public function index(Request $request)
    {
        ...
        return view('rejection.list', compact('users', 'statuses'));
    }
    ...
    public function create(CountryRepository $countryRepository, RoleRepository $roleRepository)
    {
        ...
        return view('rejection.add', compact('countries', 'roles', 'statuses'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('rejection.list')
            ->withSuccess('Asset Rejection has been created!');
    }
    ...
    public function updateDetails(User $user, Request $request)
    {
        ...
        return redirect()->route('rejection.list')
            ->withSuccess('Asset Rejection has been updated!');
